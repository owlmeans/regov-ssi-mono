...
export const ERROR_CANTVERIFY_PRESENTATION_SIGNATURE = 'ERROR_CANTVERIFY_PRESENTATION_SIGNATURE'

export const ERROR_PRESENTATION_ISNT_RESPONSE = 'ERROR_PRESENTATION_ISNT_RESPONSE'