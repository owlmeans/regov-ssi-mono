...
export const ERROR_CREDENTIAL_DOESNT_HAVE_SOURCE = 'ERROR_CREDENTIAL_DOESNT_HAVE_SOURCE'
export const ERROR_CREDENTIAL_SOURCE_UNVERIFIABLE = 'ERROR_CREDENTIAL_SOURCE_UNVERIFIABLE'
export const ERROR_SOURCE_COULDNT_INVOKE_CREDENTIAL = 'ERROR_SOURCE_COULDNT_INVOKE_CREDENTIAL'
export const ERROR_SOURCE_COULDNT_GENERATE_CREDENTIAL = 'ERROR_SOURCE_COULDNT_GENERATE_CREDENTIAL'
