...
export const SignatureRequestItemWeb = (ext: Extension): FunctionComponent<SignatureRequestItemParams> =>
  withRegov<SignatureRequestItemProps>({ namespace: ext.localization?.ns }, ({ t, i18n, wrapper, action }) => {
...
export type SignatureRequestItemProps = RegovComponetProps<SignatureRequestItemParams>