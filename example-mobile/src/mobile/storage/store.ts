...
const drivers = require('@aveq-research/localforage-asyncstorage-driver')


/**
 * @TODO Refactor to use different drivers depending on context instead of full c-p c-v
 */
export const buildStorageHelper = (
  ...
  const storage = localforage.createInstance({
    driver: drivers.driverWithoutSerialization(),
    name: config.code,
